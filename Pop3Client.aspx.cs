...
{
    public partial class Pop3Client1 : System.Web.UI.Page
    {
        public const string Host = "pop.gmail.com";
	public const int Port = 995;
	public string Email="jannatulwores@gmail.com";
	public string Password="147020121987";
	public const int NoOfEmailsPerPage = 5;
	public const string SelfLink ="<a href=\"http://www.codeproject.com/%22Pop3Client.aspx?page={0}\">{1}</a>";
	public const string DisplayEmailLink ="<a href=\"http://www.codeproject.com/%22DisplayPop3Email.aspx?emailId={0}\">{1}</a>";
